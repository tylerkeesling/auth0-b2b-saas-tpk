...
describe("Table", () => {
  ...
  it("forwards ref on TableRow", () => {
    ...
    render(
      <Table><TableBody><TableRow ref={ref}><TableCell>x</TableCell></TableRow></TableBody></Table>
    )
  ...
  it("forwards ref on TableHead", () => {
    ...
    render(
      <Table>
        <TableHeader><TableRow><TableHead ref={ref}>H</TableHead></TableRow></TableHeader>
        <TableBody><TableRow><TableCell>x</TableCell></TableRow></TableBody>
      </Table>
    )
  ...
  it("forwards ref on TableCell", () => {
    const ref = React.createRef<HTMLTableCellElement>()
    render(
      <Table><TableBody><TableRow><TableCell ref={ref}>x</TableCell></TableRow></TableBody></Table>
    )
    expect(ref.current).toBeInstanceOf(HTMLTableCellElement)
  ...
  it("forwards ref on TableFooter", () => {
    ...
    render(
      <Table>
        <TableBody><TableRow><TableCell>x</TableCell></TableRow></TableBody>
        <TableFooter ref={ref}><TableRow><TableCell>f</TableCell></TableRow></TableFooter>
      </Table>
    )
    expect(ref.current).toBeInstanceOf(HTMLTableSectionElement)
